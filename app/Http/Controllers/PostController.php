...
class PostController extends Controller
{
    ...
    public function __construct(Post $post,Category $category)  //Post = new $post;
    {
        $this->post = $post;
    ...
    private function saveImage($request){
        ...
        #saving image to public/images
        $request->image->storeAs(self::LOCAL_STORAGE_FOLDER,$image_name);
        // public/images/16543.jpeg
    ...
    public function update(Request $request, $id)
    {
        ...
        # 3. Delete all records from category_post table that are related to this post
